...
class ServicePrincipalsOperations(object):
    ...
    def create(
        ...
        :return: :class:`ServicePrincipal
         <azure.graphrbac.models.ServicePrincipal>` or
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of :class:`ServicePrincipal
    ...
    def list_owners(
            self, object_id, custom_headers=None, raw=False, **operation_config):
        """Gets the owners of a service principal.
        ...
        :rtype: :class:`UserPaged
         <azure.graphrbac.models.UserPaged>`
        :raises:
         :class:`GraphErrorException<azure.graphrbac.models.GraphErrorException>`
        """
